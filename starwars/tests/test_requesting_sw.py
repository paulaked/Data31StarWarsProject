...
class Tests(unittest.TestCase):
    ...
    def test_read_from_db(self):
        ...
        expected = {'name': 'X-wing', 'model': 'T-65 X-wing', 'manufacturer': 'Incom Corporation',
        ...
        self.assertEqual(read_from_db(), expected, "The Pilot IDs aren't being inserted properly.")
