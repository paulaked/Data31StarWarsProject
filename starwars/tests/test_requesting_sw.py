...
# Part 3 checking if output is not false.
...
class TestStarwars(unittest.TestCase):
    ...
    def test_setup_and_insert_mongodb(self):
        requesting_sw.new = []
        requesting_sw.get_starships(64, 65)
        requesting_sw.replace_links(0)
        result = requesting_sw.setup_and_insert_mongodb()
